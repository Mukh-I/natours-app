...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var markup = "<dival class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'Something went wrong loggin out');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXVraC1pIiwiYSI6ImNrYWF3czRqMTEwM3AzNHBnZ2J1dThuYzYifQ.mKzt30xQ7gr5UEol40859g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mukh-i/ckaawu9901x2x1inms3g8795x',
...
var updateDetails = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(details, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_51Grd0VGilvkt9V8CuABXvHEOtdobzUuULTbJvHXq8XHWa313oazrQ0GxvTLSfD4FyT3KGVVzDf9O6Y3W9oG73QYq00wNyvN1Ad');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // create checkout & charge card
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('confirmPassword').value; //console.log(name, email, password, passwordConfirm);
...
if (userFormData) {
  userFormData.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateDetails)(form, 'details');
  });
}
